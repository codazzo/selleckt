    ...
    */
    ...
    _.extend(SingleSelleckt.prototype, {
        ...
        _isOverflowing: function(){
            var itemsBottom = this.$items.offset().top + this.$items.height(),
                parentBottom = this.$parentEl.offset().top + this.$parentEl.height(),
                overflowHidden = this.$parentEl.css('overflow') !== 'visible';
            return overflowHidden && itemsBottom > parentBottom;
        },

        _setFixed: function(){
            var $dropdownTrigger = this.$sellecktEl.find('.selected'),
        ...
        _unsetFixed: function(){
            this.$items.attr('style', 'display: block;'); //this should be done better
        },
        ...
        render: function(){
            ...
            this.$parentEl = $sellecktEl.parent();
